...
//self.kvDB =  [[YTKKeyValueStore alloc] initDBWithName:@"test"];
//[self.kvDB createTableWithName:@"test"];
//[self.kvDB putObject:@{@"id": @1, @"name": @"tangqiao", @"age": @30} withId:@"1" intoTable:@"test"];
